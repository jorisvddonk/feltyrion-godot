...
extern void init();
extern void prepare_nearstar(void (*onPlanetFound)(int8_t type, double planet_id, double seedval, int16_t owner, int8_t moonid, double ring, double tilt, double ray, double orb_ray, double orb_tilt, double orb_orient, double orb_ecc, int16_t rtperiod, int16_t rotation, int16_t term_start, int16_t term_end, int16_t qsortindex, float qsortdist));
